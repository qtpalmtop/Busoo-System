            ...
            $("#time-selected").change(function() {
                if (selectedTime.value == 1) {
                    ...
                    stationChart.setOption({
                        ...
                        xAxis: [{
                            type: 'category',
                            data: ['1号线', '2号线', '3号线', '4号线', '5号线', '6号线', '7号线', '8号线', '9号线', '10号线', '12号线', '13号线']
                        }],
                        yAxis: [{
                            type: 'value',
                            splitArea: {
                ...
                if (selectedTime.value == 2) {
                    ...
                    stationChart.setOption({
                        ...
                        series: [{
                            name: '所有线路',
                            type: 'bar',
                            data: [82.6, 75.9, 69.0, 66.4, 78.7, 85.6, 88, 87, 78, 76, 98, 76, 56]
                        }]
                    });

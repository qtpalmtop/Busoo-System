jQuery(document).ready(function() {
	require.config({
		...
		var a = e.init(document.getElementById("station-chart"));
		a.setOption({
			tooltip: {
				trigger: "axis"
			},
			...
			series: [{
				name: "春熙路站",
				type: "bar",
				data: [55, 44.9, 77, 73.2, 85.6, 76.7, 87.6]
			}, {
				name: "龙泉驿站",
				type: "bar",
				data: [82.6, 65.9, 97, 76.4, 88.7, 70.7, 110.6]
			}]
		});
		var t = e.init(document.getElementById("station-all-chart"));
		t.setOption({
			title: {
				text: "Weekly Weather",
				subtext: "Lorem ipsum"
			...
			series: [{
					...
					itemStyle: {
						normal: {
							color: function() {
								...
								return e.getRadialGradient(300, 200, 110, 300, 200, 140, [
									[0, "rgba(255,255,0,1)"],
									[1, "rgba(30,144,250,1)"]
								])
							}(),
				...
				itemStyle: {
					...
					emphasis: {
						color: function() {
							var e = require("zrender/tool/color");
							return e.getRadialGradient(650, 200, 80, 650, 200, 120, [
								[0, "rgba(255,255,0,1)"],
								[1, "rgba(255,0,0,1)"]
							])
						}(),
